  ...
  return (
    <motion.nav
      className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        scrolled
          ? "bg-white/80 dark:bg-gray-950/80 backdrop-blur-lg shadow-[0_1px_0_rgba(34,197,94,0.08)]"
          : "bg-transparent"
      }`}
      initial={{ y: -80 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <a href="#home" className="font-mono text-lg tracking-tight group">
          <span className="text-green-500 dark:text-green-400 group-hover:text-green-600 dark:group-hover:text-green-300 transition-colors">
            {"<"}
          </span>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6">
        {/* Greeting line */}
        <motion.p
          className="text-sm font-mono text-green-500 dark:text-green-400 mb-6 tracking-wider"
        ...
        {/* Name with scramble */}
        <motion.h1
          className="text-5xl sm:text-6xl md:text-8xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <span className="text-green-600 dark:text-green-400 font-semibold">{scrambledTitle}</span>
          <span className="cursor-blink text-green-500 dark:text-green-400 select-none">_</span>
        </motion.div>
        ...
        >
          <a
            href="#projects"
            className="px-6 py-3 rounded-full bg-green-600 dark:bg-green-600 text-white text-sm font-semibold hover:bg-green-700 dark:hover:bg-green-700 transition-colors duration-300 shadow-lg shadow-green-600/20"
          >
            View My Work
          </a>
          <a
            href="#contact"
            className="px-6 py-3 rounded-full border border-green-200 dark:border-green-900 text-green-700 dark:text-green-400 text-sm font-semibold hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors duration-300"
          >
            Get In Touch
          </a>
        </motion.div>
...
function About() {
  ...
  return (
    <section id="about" ref={ref} className="py-28 bg-gradient-to-b from-green-50/60 to-white dark:from-gray-900 dark:to-gray-950">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          {/* Text */}
          <motion.div
            className="md:col-span-3 space-y-5 text-gray-600 dark:text-gray-400 leading-relaxed text-[15px]"
            initial={{ opacity: 0, y: 30 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          >
            ...
            <div className="pt-4 flex flex-wrap gap-3">
              <span className="inline-flex items-center gap-1.5 text-xs font-mono text-green-600 dark:text-green-400 bg-green-50 dark:bg-gray-900 px-3 py-1.5 rounded-full border border-green-100 dark:border-green-900">
          ...
          >
            {stats.map((s, _i) => (
                <motion.div
                  key={s.label}
                  className="p-5 rounded-2xl bg-white dark:bg-gray-950 shadow-sm border border-green-100/80 dark:border-green-900 hover:shadow-md hover:border-green-200 dark:hover:border-green-700 transition-all duration-300"
                  variants={{
...
function SkillPill({
  ...
  return (
    ...
    >
      ...
      <motion.span
        className="px-4 py-2 rounded-full bg-green-50 dark:bg-gray-900 text-green-700 dark:text-green-400 text-sm font-medium border border-green-100 dark:border-green-900 hover:bg-green-100 dark:hover:bg-green-900/40 hover:border-green-300 dark:hover:border-green-700 cursor-default select-none"
        whileHover={{
          scale: 1.08,
          y: -3,
      ...
      {active && details && (
        <AnimatePresence>
          ...
          >
            <motion.div
              className="relative px-3 py-2 rounded-xl bg-slate-50 dark:bg-gray-800 border border-emerald-200 dark:border-gray-700 shadow-sm shadow-emerald-100 dark:shadow-none"
              initial={{ opacity: 0, y: 4 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 4 }}
              transition={{ duration: 0.2 }}
            >
              <div className="text-xs font-mono text-green-700 dark:text-green-400 font-semibold mb-1">
                {name}
              </div>
              <div className="text-[11px] font-mono text-slate-600 dark:text-gray-300">
              ...
              <div
                className="absolute bottom-[-5px] w-2.5 h-2.5 bg-slate-50 dark:bg-gray-800 border-r border-b border-emerald-200 dark:border-gray-700 rotate-45"
                style={{
...
function Skills() {
  ...
  return (
    <section id="skills" ref={ref} className="py-28 bg-white dark:bg-gray-950">
      <div className="max-w-5xl mx-auto px-6">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <div className="mb-14 flex w-fit max-w-full flex-wrap items-center gap-x-3 gap-y-2">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 max-w-full break-words">
              Skills & Tools
            </h2>
            <ScrollHint
...
function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="pt-28 pb-20 bg-white dark:bg-gray-950">
        ...
        >
          {socials.map((s) => (
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 px-5 py-3 rounded-full border border-green-200 dark:border-green-900 hover:bg-green-50 dark:hover:bg-green-900/20 hover:border-green-400 transition-all duration-300"
              whileHover={{ y: -2 }}
            >
              <span className="w-9 h-9 rounded-full bg-green-100 dark:bg-green-900/40 flex items-center justify-center text-green-700 dark:text-green-400 font-mono text-xs font-bold group-hover:bg-green-200 dark:group-hover:bg-green-800 transition-colors">
                {s.icon}
              </span>
...
export default function App() {
  return (
    <main className="bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased">
      <Navigation />
      <Hero />
      <About />
      <Skills />
